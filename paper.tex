...
MarS-FM ensemble integration (H3 + magnitude estimator)      & v0.4 (checkpoint pending) \\
...
\begin{enumerate}[leftmargin=*,itemsep=4pt]
  \item \textbf{MarS-FM as a fourth ensemble source for H3 and
        ...
        official checkpoint is not yet released, but a
        \texttt{vampnet load\_ensemble \dots source marsfm} loader
        stub is wired in v0.3 for \texttt{.npz} or
        PDB-directory outputs; v0.4 runs MarS-FM on the Notch1 NRR
        apo and holo sequences and feeds the resulting ensembles
        into the existing VAMPnet pipeline. The membrane-anchor
        artifact applies equally to any generative method trained
        on unrestrained MD-Cath data; the v0.3 COM-distance
        restraint stays as the classical-MD reference.
